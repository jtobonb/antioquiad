...
class MunicipiosControllerTest < ActionController::TestCase
  ...
  test "should create municipio" do
    assert_difference('Municipio.count') do
      post :create, municipio: { cod_municipio: @municipio.cod_municipio, cod_subregion: @municipio.cod_subregion, nombre_municipio: @municipio.nombre_municipio }
    end
  ...
  test "should update municipio" do
    put :update, id: @municipio, municipio: { cod_municipio: @municipio.cod_municipio, cod_subregion: @municipio.cod_subregion, nombre_municipio: @municipio.nombre_municipio }
    assert_redirected_to municipio_path(assigns(:municipio))
  end
