...
class EquiposControllerTest < ActionController::TestCase
  ...
  test "should create equipo" do
    assert_difference('Equipo.count') do
      post :create, equipo: { dane_sede: @equipo.dane_sede, fecha_entrega: @equipo.fecha_entrega, id_equipo: @equipo.id_equipo, origen: @equipo.origen, tipo: @equipo.tipo }
    end
  ...
  test "should update equipo" do
    put :update, id: @equipo, equipo: { dane_sede: @equipo.dane_sede, fecha_entrega: @equipo.fecha_entrega, id_equipo: @equipo.id_equipo, origen: @equipo.origen, tipo: @equipo.tipo }
    assert_redirected_to equipo_path(assigns(:equipo))
  end
