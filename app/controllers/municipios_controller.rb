class MunicipiosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @municipio.save
        format.html { redirect_to @municipio, notice: 'El municipio fue creado satisfactoriamente.' }
  ...
  def update
    ...
    respond_to do |format|
      if @municipio.update_attributes(params[:municipio])
        format.html { redirect_to @municipio, notice: 'El municipio fue actualizado satisfactoriamente.' }
